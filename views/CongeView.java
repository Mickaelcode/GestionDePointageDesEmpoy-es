...
public class CongeView extends JPanel {
    ...
    public CongeView(){
               ...
               java.util.Date utilDateDemande = (java.util.Date) dateTimeFirst.getValue();
                ...
                if(response == JOptionPane.YES_OPTION){
                    ...
                    if(validate =="VITA"){
                        ...
                        else JOptionPane.showMessageDialog(null, "Cette employe n'a plus que "+days+" jours  pour congé");
                        clear();
                    }
                }
            }
        ...
        rechButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if(days == 0) JOptionPane.showMessageDialog(null, "Cette employé n' a plus de jours pour congé");
                else if (days==30) JOptionPane.showMessageDialog(null, "Cette employé n' a pas encore fait de congé");
                else JOptionPane.showMessageDialog(null, "Cette employe a encore "+days+" jours de jours pour congé");
                clear();
            }
        });
    ...
    private void modifierConge(String numConge,String numEmp,String motif,int nbJours,Timestamp strDateDemande,Timestamp strDateretour){
        try{
    ...
    private String createConge(String numConge,String numEmp,String motif,int nbJours,Timestamp timeFirst,Timestamp timeEnd){
        String answer = "";
        String send = "";
        try{
        Conge conge = new Conge(numConge,numEmp,motif,nbJours,timeFirst,timeEnd);
        answer = conge.addConge();
        if (answer =="Maximum")send = "Max";
        else if(answer =="VITA") send = "VITA";
